...
- [Purpose](#purpose)
  - [Current Pain Points with REST](#current-pain-points-with-rest)
  - [Expected Benefits of GraphQL](#expected-benefits-of-graphql)
- [Scope](#scope)
  - [In-Scope](#in-scope)
- [GraphQL Fundamentals - How-to GraphQL](#graphql-fundamentals---how-to-graphql)
  - [What is GraphQL?](#what-is-graphql)
  - [Key Concepts](#key-concepts)
    - [1. Schema Definition Language (SDL)](#1-schema-definition-language-sdl)
    - [2. Queries - Reading Data](#2-queries---reading-data)
    - [3. Mutations - Modifying Data](#3-mutations---modifying-data)
    - [4. Resolvers - The Implementation](#4-resolvers---the-implementation)
    - [4a. DataLoaders - Solving the N+1 Problem](#4a-dataloaders---solving-the-n1-problem)
    - [4b. Projections - Database Column-Level Optimization](#4b-projections---database-column-level-optimization)
    - [5. Type System - Strong Typing](#5-type-system---strong-typing)
  - [Advanced GraphQL Features](#advanced-graphql-features)
    - [Fragments - Reusable Field Sets](#fragments---reusable-field-sets)
    - [Directives - Conditional Queries](#directives---conditional-queries)
  ...
  - [Best Practices](#best-practices)
    ...
    - [3. Nullable vs Non-Nullable](#3-nullable-vs-non-nullable)
    - [5. DataLoaders for N+1 Problems](#5-dataloaders-for-n1-problems)
  - [GraphQL vs REST](#graphql-vs-rest)
- [Technology Stack for GraphQL Implementation](#technology-stack-for-graphql-implementation)
  - [Backend (.NET 9)](#backend-net-9)
    - [HotChocolate 13.x vs GraphQL.NET - Detailed Comparison](#hotchocolate-13x-vs-graphqlnet---detailed-comparison)
- [Three Migration Approaches - Comparative Analysis](#three-migration-approaches---comparative-analysis)
  - [Approach 1: REST-over-GraphQL (Internal GraphQL Layer)](#approach-1-rest-over-graphql-internal-graphql-layer)
  - [Approach 2: Gradual Migration (Strangler Pattern)](#approach-2-gradual-migration-strangler-pattern)
  - [Approach 3: Permanent Hybrid (Keep Both APIs)](#approach-3-permanent-hybrid-keep-both-apis)
- [ApplicationController Endpoint Analysis](#applicationcontroller-endpoint-analysis)
  - [Complete Endpoint Inventory](#complete-endpoint-inventory)
    - [Excellent Candidates for GraphQL (11 endpoints)](#excellent-candidates-for-graphql-11-endpoints)
    - [Keep as REST (2 endpoints)](#keep-as-rest-2-endpoints)
